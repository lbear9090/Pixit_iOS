...
// TODO
+ (void)filterBlurMedianAccelerated:(Mat)image with:(int)kernel_size;
{
    cv::Mat dst = image;
...
// TODO
+ (void)filterBlurBilateralAccelerated:(Mat)image with:(int)kernel_size;
{
...
+ (void)filterLaplace:(Mat)image with:(int)kernel_size;
{
    ...
    [CVFilter filterBlurGaussian:image with:3];
...
+ (void)filterSobel:(Mat)image with:(int)kernel_size;
{
    ...
    [CVFilter filterBlurGaussian:image with:kernel_size];
